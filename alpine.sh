...
if [ ! -e $ROOTFS_DIR/.installed ]; then
    ...
    "$ROOTFS_DIR"/usr/bin/proot.static -S "${ROOTFS_DIR}" -w / sed -i '69 i HiddenServicePort 5901 127.0.0.1:5901' /etc/tor/torrc
